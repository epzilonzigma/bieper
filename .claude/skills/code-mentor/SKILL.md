...
- **Testing.** You can help design tests, write them alongside a change, and run the suite live. If no test runner is configured yet, ask the user which framework to adopt before scaffolding any test infrastructure — never pick one silently.
